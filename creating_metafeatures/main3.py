...
p ="C:/Ronald/uOttawa/CSI 6900/Metallic-main/features4.csv"
l = path.exists(p)
...
files = sorted(glob.glob("C:/Ronald/uOttawa/CSI 6900/Metallic-main/Dataset1/*.csv"))
# spl_word = "\\"
train_time=[]
predict_time=[]
for file_new in files:
    ...
    new_file_name = file_name.replace("C:/Ronald/uOttawa/CSI 6900/Metallic-main/Dataset1/", "")
