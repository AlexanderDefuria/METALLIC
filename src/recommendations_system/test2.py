...
# filename="C:/Ronald/uOttawa/CSI 6900/Metallic-main/Dataset/BreastCancer.csv" #input("enter the file name:")

df = pd.read_csv("../features.csv") #features_regression.csv
filename="../datasets/BreastCancer.csv" #input("enter the file name:
